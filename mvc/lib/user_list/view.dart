...
import 'package:mvc/user_detail/view.dart' as detail;
...
class ViewState extends State with SignalApiView {
  ...
  void initState() {
    ...
    Control.getUserList(this);
    _controller.addListener(() {
      if (_controller.position.pixels == _controller.position.maxScrollExtent) {
        Control.getUserList(this, _data.last.id);
        showLoading();
      }
    });
    super.initState();
  ...
  void error(Exception e) {
    showError(context).then((value) {
      if (value) Control.getUserList(this, !init ? null : _data.last.id);
    });
    super.error(e);
  }
}
